...
topState() {
	//checks to see if previos state
}
componentDidUpdate() {
			...
			$.ajax({
							...
							success: function (data) {
								...
								var previousState = nextDayThis.state.day1_day;
								if(nextDayThis.state.day1_temp_high !== day1_temp_high) {
									// console.log("state already set")
									console.log("changing state")
									console.log("day1_day: " + day1_day + "state: " + previousState)
			...
			<div>
			   <div className="col-sm-6">
						<div className="well text-center">
							...
							<h3 className="h3_temperature"><span className="temperature">
								{this.state.day1_temp_high}<small>F</small></span> <span className="hi_lo">Hi</span>
							</h3>
